...
from .modeling import (
    DCFormer,
    ImageEncoderViT,
    MaskDecoder,MaskDecoder_sammed,
    PromptEncoder,
    Sam,
    TwoWayTransformer,
)
...
def teacher(checkpoint=None):
    return _build_sam_teacher(
...
def _build_sam_teacher(
        ...
        image_size,
        encoder_adapter,
        checkpoint="D:/python/a_segment_project/mysam/sam-med2d_b.pth",
):
    prompt_embed_dim = 256
    ...
    sam = Sam(
        ...
        mask_decoder=MaskDecoder_sammed(
            num_multimask_outputs=3,
            transformer=TwoWayTransformer(
                depth=2,
                embedding_dim=prompt_embed_dim,
